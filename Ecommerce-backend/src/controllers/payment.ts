...
import { CoupenType } from "../types/types.js";

export const newCreateCoupen = async (
  req: Request<{}, {}, CoupenType>,
  res: Response,
  next: NextFunction
) => {
  try {
...
export const coupenDelete = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
